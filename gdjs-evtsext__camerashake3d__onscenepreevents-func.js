...
let isConditionTrue_0 = false;
{
{gdjs.evtsExt__CameraShake3D__SpinCamera.func(runtimeScene, 0 - eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).getAsString()).getChild("CameraDeltaAngleZ").getAsNumber(), eventsFunctionContext.localVariables[0].getFromIndex(0).getAsString(), eventsFunctionContext);
}{gdjs.evtsExt__CameraShake3D__TurnCameraHorizontally.func(runtimeScene, 0 - eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).getAsString()).getChild("CameraDeltaAngleY").getAsNumber(), eventsFunctionContext.localVariables[0].getFromIndex(0).getAsString(), eventsFunctionContext);
}{gdjs.evtsExt__CameraShake3D__TurnCameraVertically.func(runtimeScene, 0 - eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).getAsString()).getChild("CameraDeltaAngleX").getAsNumber(), eventsFunctionContext.localVariables[0].getFromIndex(0).getAsString(), eventsFunctionContext);
}}
