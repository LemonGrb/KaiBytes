...
let isConditionTrue_0 = false;
{
{gdjs.evtsExt__CameraShake3D__SetFrequency.func(runtimeScene, eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).getAsNumber(), "", eventsFunctionContext);
...
if (isConditionTrue_0) {
{gdjs.evtsExt__CameraShake3D__SetFrequency.func(runtimeScene, eventsFunctionContext.sceneVariablesForExtension.getFromIndex(6).getChild("Frequency").getAsNumber(), "", eventsFunctionContext);
}}
...
if (isConditionTrue_0) {
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).getAsString()).getChild("CameraDeltaAngleX").setNumber(gdjs.evtsExt__CameraShake3D__Noise2d.func(runtimeScene, "", gdjs.evtTools.runtimeScene.getTimeFromStartInSeconds(runtimeScene), 3000, eventsFunctionContext) * eventsFunctionContext.localVariables[0].getFromIndex(2).getAsNumber() * eventsFunctionContext.localVariables[0].getFromIndex(3).getAsNumber());
}{gdjs.evtsExt__CameraShake3D__TurnCameraVertically.func(runtimeScene, eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).getAsString()).getChild("CameraDeltaAngleX").getAsNumber(), eventsFunctionContext.localVariables[0].getFromIndex(4).getAsString(), eventsFunctionContext);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__CameraShake3D__IsShaking.func(runtimeScene, eventsFunctionContext);
if (isConditionTrue_0) {
