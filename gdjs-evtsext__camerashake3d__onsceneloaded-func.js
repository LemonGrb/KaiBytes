...
const repeatCount2 = gdjs.evtsExt__CameraShake3D__LayerCount.func(runtimeScene, eventsFunctionContext);
for (let repeatIndex2 = 0;repeatIndex2 < repeatCount2;++repeatIndex2) {

let isConditionTrue_0 = false;
if (true)
{
{gdjs.evtsExt__CameraShake3D__SetLayerShakable.func(runtimeScene, true, gdjs.evtsExt__CameraShake3D__LayerName.func(runtimeScene, eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber(), eventsFunctionContext), eventsFunctionContext);
